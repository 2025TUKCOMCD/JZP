  ...
  return (
    ...
    `}
        ...
        <div className="flex mb-6">
          <img src={movie1Image} alt="범죄도시 4" className="w-30 h-52 mr-3" />
          <div className="flex flex-col justify-between flex-1">
            <div>
              <div className="flex items-center mb-2">
                <img src={age15Image} alt="15세" className="w-10 h-10 mr-3" />
                <h3 className="text-3xl font-sbAggro font-bold">범죄도시 4</h3>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              {times.map((time, index) => (
                <button
                  ...
                  className={`border w-full h-[66px] flex flex-col justify-center items-center ${
                ...
                >
                  ...
                  <div className="flex justify-between w-full text-[14px] mt-1 px-2">
        ...
        {/* Wicked */}
        <div className="flex mb-6">
          <img src={movie2Image} alt="Wicked" className="w-30 h-52 mr-3" />
          <div className="flex flex-col justify-between flex-1">
            <div>
              <div className="flex items-center mb-2">
                <img src={age12Image} alt="12세" className="w-10 h-10 mr-3" />
                <h3 className="text-3xl font-sbAggro font-bold">WICKED</h3>
              </div>
              <p className="text-lg text-gray-400">2D 디지털더빙</p>
            </div>
            <div className="grid grid-cols-2 gap-2 mt-2">
        ...
        {/* 모아나 2 */}
        <div className="flex mb-6">
          <img src={movie3Image} alt="모아나 2" className="w-30 h-52 mr-3" />
          <div className="flex flex-col justify-between flex-1">
            <div>
              <div className="flex items-center mb-2">
                <img src={age12Image} alt="12세" className="w-10 h-10 mr-3" />
                <h3 className="text-3xl font-sbAggro font-bold">모아나 2</h3>
              </div>
              <p className="text-lg text-gray-400">2D 디지털더빙</p>
            </div>
            <div className="grid grid-cols-2 gap-2 mt-2">
